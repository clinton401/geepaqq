...
import proflePic from '../../assets/Rectangle 1061.png'
...
import AsideMenu2 from '../AsideMenu/AsideMenu2';
...
function NavBar() {
  ...
  //     prf: false
  // })
  const { showMenu, setShowMenu, ppMode, setPpMode, lightMode } = useContext(myContext);
  ...
  useEffect(() => {
    showMenu ? setMenu("close") : setMenu("show");
  }, [showMenu]);
  useEffect(() => {
    function getDate() {
      const date = new Date();
  ...
  return (
    <header id={!lightMode ? "darkmode" : ""}>
      <nav aria-label="dashboard and search" className={ncss.ds}>
        {/* <button></button> */}
        ...
        <h2>Dashboard</h2>
        <span className={ncss.search_span}>
          <input type="text" className={ncss.search} placeholder="Search..." />
          <button className={ncss.search_icon}>
            <svg
      ...
      <nav aria-label=" date and profile" className={ncss.dp}>
        <span className={ncss.date}>
          <svg
            id={!lightMode ? "drkmode" : ""}
            className={ncss.cl1}
            xmlns="http://www.w3.org/2000/svg"
          ...
          <button className={ncss.cl2} onClick={() => btnHandler("calender")}>
            <svg
              id={!lightMode ? "drkmode" : ""}
              xmlns="http://www.w3.org/2000/svg"
              width="20"
        ...
        <button
          className={ncss.notification}
          onClick={() => btnHandler("noti")}
        >
          <svg
            id={!lightMode ? "drkmode" : ""}
            xmlns="http://www.w3.org/2000/svg"
          ...
          {/* <AnimatePresence> */}
          {ppMode.noti && (
            <PopUp cls={ppMode.noti ? "active" : ""}>
              <h6>No notification</h6>
            </PopUp>
          )}
          {/* </AnimatePresence> */}
        </button>
        <button className={ncss.profile} onClick={() => btnHandler("prf")}>
          <img src={proflePic} alt="profile picture" />
          <span>
            <p>Justin Bergson</p>
      ...
      <div className={ncss.sdiv}>
        {showMenu && (
          <div
            className={`ndiv ${showMenu ? "active" : ""}`}
