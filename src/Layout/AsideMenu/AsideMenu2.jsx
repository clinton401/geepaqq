...
import acss from "./AsideMenu.module.css";
import "../../index.css";
...
function AsideMenu2() {
   ...
   const { lightMode, setLightMode, setShowMenu, resetPpMode } =
     useContext(myContext);
  const classesName = lightMode ? "light" : "";
  const classesName2 = !lightMode ? "dark" : "";
  const modeHandler = () => {
  ...
  return (
    <motion.aside
      className={acss.aside}
      id="links_aside"
      variants={animationVariant}
      initial="hidden"
      animate="visible"
    >
      <section id={!lightMode ? "dkmode" : ""}>
        <div>
          ...
          <span className={acss.asidespan}>
            <NavLink onClick={menuHandler} to="/" activeclassname="active">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <span className={acss.asidespan}>
            <NavLink activeclassname="active" onClick={menuHandler} to="/chart">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <span className={acss.asidespan}>
            <NavLink activeclassname="active" onClick={menuHandler} to="/sales">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <span className={acss.asidespan}>
            <NavLink activeclassname="active" onClick={menuHandler} to="/info">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <button className={acss.dltoggle} onClick={modeHandler} id='dltoggle'>
            <span className={`sun ${classesName}`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
            ...
            <span className={`moon ${classesName2}`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
